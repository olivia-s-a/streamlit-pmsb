...
itens = [
    ("Subprefeituras", "Lorem ipsum dolor sit amet...", 'subpref'),
    ("Distritos", "Lorem ipsum dolor sit amet...", 'distrito'),
    ("Favelas e Comunidades Urbanas", "Lorem ipsum dolor sit amet...", 'fcu'),
    ("Sub Bacias Hidrográficas", "Lorem ipsum dolor sit amet...", 'subbac')
]
...
unidades = pd.DataFrame(itens, columns=['name', 'desc', 'gdf_name'])
